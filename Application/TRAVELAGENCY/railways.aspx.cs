...
namespace TRAVELAGENCY
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DropDownList1.Items.Insert(0, new ListItem("Please Select a Railways", String.Empty));
            DropDownList1.Items.Insert(1, new ListItem("National Rail", "10"));
            DropDownList1.Items.Insert(2, new ListItem("EuroStar", "15"));
            DropDownList1.Items.Insert(3, new ListItem("British Rail", "12"));
            DropDownList1.Items.Insert(4, new ListItem("Network Rail", "14"));
            DropDownList1.Items.Insert(5, new ListItem("Alsa", "9"));
            DropDownList1.Items.Insert(6, new ListItem("American Express", "17"));
            DropDownList1.Items.Insert(7, new ListItem("LNER", "6"));
            DropDownList1.Items.Insert(8, new ListItem("Italia Rail", "11"));
            DropDownList1.Items.Insert(9, new ListItem("Blue Train", "8"));
            DropDownList1.Items.Insert(10, new ListItem("Orient Express", "12"));
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            int railway_id = service_id;
            string sqlStr11 = "INSERT Railway(railway_id, railway_name, railway_ticket_price ) VALUES ('" + railway_id.ToString() + "','" + DropDownList1.SelectedItem.Text + "','" + (Convert.ToDouble(DropDownList1.SelectedItem.Value)).ToString() + "')";
